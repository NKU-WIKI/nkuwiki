...
def generate_abstract(file_path: str, max_length: int = 300) -> Optional[str]:
    ...
    coze_poll_chat_status(conversation_id, chat_id)
...
def coze_poll_chat_status(conversation_id: str, chat_id: str, max_retries: int = 10, poll_interval: float = 10) -> Optional[str]:
    """
    轮询检查对话状态
