...
class SentenceSplitterConfig(BaseModel):
    """Configuration for SentenceSplitter."""
...
class SentenceSplitter(MetadataAwareTextSplitter):
    ...
    # Internal fields without leading underscore in Field definition
    chunking_tokenizer_fn: Optional[Callable[[str], List[str]]] = Field(
        default=None,
        exclude=True,
        alias="_chunking_tokenizer_fn"
    )
    ...
    split_fns: List[Any] = Field(
        default_factory=list,
        exclude=True,
        alias="_split_fns"
    )
    sub_sentence_split_fns: List[Any] = Field(
        default_factory=list,
        exclude=True,
        alias="_sub_sentence_split_fns"
    )
