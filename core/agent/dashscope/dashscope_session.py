...
logger = register_logger("core.agent.dashscope")
...
class DashscopeSession(Session):
    def __init__(self, session_id, system_prompt=None):
        ...
        self.config = Config()
        self.max_tokens = self.config.get("core.agent.dashscope.max_tokens", 2000)
        self.reset()
...
class DashscopeSessionManager(SessionManager):
    def __init__(self):
        super().__init__(DashscopeSession) 