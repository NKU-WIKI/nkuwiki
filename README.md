# nkuwiki 开放的南开百科 [![Version](https://img.shields.io/badge/version-0.0.1-blue.svg)](https://github.com/your-org/nkuwiki/releases) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
...
⭐ **立即加入**：添加微信 `ao_kimi` 或飞书联系 @廖望 ，或者联系开发团队或志愿者团队任意成员。
