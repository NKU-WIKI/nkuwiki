...
from . import user, post, notification, feedback, about, action, banwords, comment, auth, upload
...
router.include_router(upload.router, prefix="/upload", tags=["wxapp-upload"])
